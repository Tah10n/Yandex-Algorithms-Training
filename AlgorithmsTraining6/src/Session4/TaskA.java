...
public class TaskA {
    public static void main(String[] args) throws IOException {
        System.out.println(printAllNodesWithDeep(readInput("input.txt")));
    }
    ...
    public static String printAllNodesWithDeep(Input input) {
        StringBuilder stringBuilder = new StringBuilder();
        ...
        for (Node node : map.values()) {
            stringBuilder.append(node.key).append(" ").append(node.deep).append("\n");
        }
